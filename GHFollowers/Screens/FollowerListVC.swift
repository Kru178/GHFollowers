...
//  GHFollowers
//
//  Created by Sergei Krupenikov on 14.10.2020.
//
...
class FollowerListVC: GFDataLoadingVC {
    ...
    func configureSearchController() {
        ...
        searchController.searchBar.placeholder = "Search user here"
    ...
    func addUserToFavorites(user: User) {
        ...
        PersistenceManager.updateWith(favorite: favorite, actionType: .add) { [weak self] error in
            ...
            guard let error = error else {
                self.presentGFAlertOnMainThread(title: "Success", message: "You've just favorited a new person!", buttonTitle: "Awesome!")
                return
            }
